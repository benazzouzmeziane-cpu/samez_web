    ...
    <div className="pt-32 pb-24 px-6 max-w-6xl mx-auto">
      <div className="max-w-3xl">
        ...
        <div className="space-y-10 text-slate-400 leading-relaxed text-sm">
          {/* Objet */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">1. Objet</h2>
            <p>
          ...
          {/* Prestations */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">2. Prestations</h2>
            <p>
          ...
          {/* Devis et commande */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">3. Devis et commande</h2>
            <p>
          ...
          {/* Tarifs */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">4. Tarifs</h2>
            <p>
          ...
          {/* Paiement */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">5. Modalités de paiement</h2>
            <p>
          ...
          {/* Délais */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">6. Délais de réalisation</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">7. Propriété intellectuelle</h2>
            <p>
          ...
          {/* Responsabilité */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">8. Responsabilité</h2>
            <p>
          ...
          {/* Résiliation */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">9. Résiliation</h2>
            <p>
          ...
          {/* Confidentialité */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">10. Confidentialité</h2>
            <p>
          ...
          {/* Droit applicable */}
          <section>
            <h2 className="font-display text-lg font-semibold text-white mb-4">11. Droit applicable et litiges</h2>
            <p>
